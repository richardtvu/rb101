...
def calculate_payment_plan(loan_amount, annual_percentage_rate, loan_duration_years, loan_duration_months) 
  monthly_payment = ''
...
def test_calculate_payment_plan(expected_payment_plan, loan)
