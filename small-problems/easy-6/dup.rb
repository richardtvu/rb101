...
Input: Array
Output: Object (duplicate)
Requirements:
- Return the duplicate value
- There is only one duplicatae value.
- Questions (if needed to go beyond test cases):
  - What data types can the elements in the array be?

DSA
- Hash

Count the frequencies of each value.
Return the value whose frequency is 2.
...
def find_dup(arr)
  ...
  frequencies.each { |k, v| return k if v == 2 }
end
